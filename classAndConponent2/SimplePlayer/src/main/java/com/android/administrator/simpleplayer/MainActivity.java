...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener playControllerClick = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 播放控制布局
        findViewById(R.id.playController).setOnClickListener(playControllerClick);
    ...
    private void initPlayControllerInfo(List<MusicEntity> data, int index){
        ...
        // 设置专辑图片
        Bitmap bitmap = AlbumBitmapUtil.getAlbumImage(this, entity.getAlbumId(), 40, 40, false);
        if(bitmap == null){
