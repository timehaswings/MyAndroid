...
public class AlbumBitmapUtil {
    ...
    public static Bitmap getAlbumImage(Context context, String albumId, int dstWidth, int dstHeight){
        Bitmap bitmap = BitmapCacheUtil.getInstance().getBitmap(albumId);
        if(bitmap != null){
            return bitmap;
        }
